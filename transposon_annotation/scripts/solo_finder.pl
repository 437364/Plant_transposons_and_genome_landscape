...
while (<RM>){
	...
	# determine if this is an LTR region with enough coverage
	my $is_ltr = 0;
	...
	if (@arr>5){
		...
		foreach ($arr[0], $arr[1], $arr[3], $arr[4]){
			...
			# print out the surrounding intervals for selected solo LTR
			# print "Element near LTR ending at 9487910: $loc0\n" if $e2 == 9487910;
